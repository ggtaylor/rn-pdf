...
export default function OfflineScreen() {
  const htmlRaw = require("../../assets/pdf/test_offline.html");
  ...
  return (
    ...
    >
      <ThemedView style={styles.titleContainer}>
        <ThemedText type="title">PDF Local Offline</ThemedText>
      </ThemedView>
      <ThemedText>
        Load all resources and PDF locally, without network connection
      </ThemedText>
